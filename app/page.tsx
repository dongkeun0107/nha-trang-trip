...
const days: Day[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: "13:30", title: "마사지 60분", note: "안나스파, 예약 일정 확인", icon: "💆" },
...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-slate-100 px-4 py-5 text-slate-900 md:px-8 md:py-8">
      <button
        type="button"
        onClick={goToScheduleMenu}
        className="fixed bottom-5 right-5 z-50 rounded-full bg-sky-600 px-5 py-4 text-lg font-black text-white shadow-lg active:scale-95"
      >
        일정 보기
      </button>
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <section id="schedule-menu" className="rounded-3xl bg-white p-4 shadow-md ring-1 ring-slate-100">
